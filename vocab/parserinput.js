...
var data = [
    ...
    ['aggressive','hostile','militant','warlike'], //35-38
];
//1-38
*/
...
var data = [
    ...
    ['essential','vital','crucial','critical','decisive','indispensable','imperative','pivotal'] //72-79
];
//39-79
*/
...
var data = [
    ...
    ['evidence','proof','support','testimony','demonstration'], //85
    ['exact','precise','accurate','specific'], //90
    ['exaggerate','overstate','dramatize','embellish','inflate'], //94
    ['excellent','outstanding','perfect','superb'], //99
    ['excited','ecstatic','elated','euphoric','rapturous','exhilarated'], //103
    ['expand','widen','extend','enlarge','broaden','lengthen','stretch'], //109
